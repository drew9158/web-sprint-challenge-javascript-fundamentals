...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPopulation = array.filter((array) => {
...
function greeting(firstName, lastName){
  return consume(firstName, lastName, () => {return `Hello ${firstName} ${lastName}, nice to meet you!`;});
}
